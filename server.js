...
// When TUNNEL_URL is set, AG2R is behind a reverse proxy that handles TLS termination
...
async function start() {
  ...
  // Generate/load SSL certs (skipped when behind a reverse proxy)
